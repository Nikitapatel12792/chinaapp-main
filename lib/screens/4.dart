...
class _FourState extends State<Four> {
      ...
      if (internet) {
        ideaprovider().idealistapi(data).then((response) async {
          ...
          if (response.statusCode == 200 &&
            ...
            print(idealistmodal?.data?[0].buttonExperience);
            setState(() {
              isLoading = false;
            });
          } else {
      ...
      if (internet) {
        ideaprovider().experincebuttonapi(data).then((response) async {
          ...
          if (response.statusCode == 200 &&
            ...
            idealistap();
           idealistmodal?.data?[sel!].buttonExperience == "0" ? buildErrorDialog(context, "经验", "你已经体验过这个想法"):buildErrorDialog(context, "经验", "你已经消除了这个想法");
      ...
      if (internet) {
        ideaprovider().collectionbuttonapi(data).then((response) async {
          ...
          if (response.statusCode == 200 &&
            ...
            idealistmodal?.data?[COLLSEL!].buttonCollected == "0" ? buildErrorDialog(context, "收藏", "这个想法已添加到您的收藏中"):buildErrorDialog(context, "收藏", "此创意已从您的收藏中删除");
            idealistap();
            setState(() {
              isLoading = false;
            });
  ...
  String getCurrentDate() {
    ...
    final formatter = DateFormat('yyyy-MM-dd'); // You can customize the date format as needed
